...
extern void error_symbol_redefined_module(const char* symbol,
        const char* module);
...
extern void error_obj_file_version(const char* filename, int found_version,
                                   int expected_version);
extern void error_not_lib_file(const char* filename);
extern void error_lib_file_version(const char* filename, int found_version,
                                   int expected_version);
